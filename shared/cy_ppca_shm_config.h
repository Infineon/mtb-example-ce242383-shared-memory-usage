/*****************************************************************************
 * \file    shared_memory_config.h
 * \brief   Share memory configuration header file.
 * 
...
#define CONFIG_USE_LOCK_MAX_CHAL_NUM        3
    #define SM_CHNL_MAIN_PPCA0              0
    #define SM_CHNL_MAIN_PPCA1              1
    #define SM_CHNL_PPCA0_PPCA1             2
