/*****************************************************************************
 * \file    sm_vars.h
 * \brief   Shared memory variables for inter-core communication.
 * 
...
extern volatile uint32_t    sm_current_c1 ;
extern volatile uint32_t    sm_voltage_c0 ;     
extern volatile uint32_t    sm_power ;     

extern volatile mutex_t     mutex_c0;
extern volatile mutex_t     mutex_c1;
