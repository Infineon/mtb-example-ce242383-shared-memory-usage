...
__SM_ATTR__ uint32_t    sm_current_c1;  
__SM_ATTR__ uint32_t    sm_voltage_c0;
__SM_ATTR__ uint32_t    sm_power;

__SM_ATTR__ mutex_t    mutex_c0;
__SM_ATTR__ mutex_t    mutex_c1;
